        ...
        return products.value
            ...
            .map(p => {
                ...
                if (p.id === "after-motion") {
                    if (dbDevice.value && (dbDevice.value.includes("Android") || dbDevice.value.includes("AfterMotion"))) {
                        status = "active";
                        deviceVal = dbDevice.value;
                    } else {
                        status = "offline";
                        deviceVal = dbDevice.value || "Android App Client";
                    }
                } else if (p.id === "zenfile") {
                    if (dbDevice.value && dbDevice.value.includes("ZenFile")) {
                        status = "active";
                        deviceVal = dbDevice.value;
                    } else {
                        status = "offline";
                        deviceVal = "ZenFile Desktop Client v1.2";
                    }
                }
                    ...
                    {!activeProduct.value ? (
                        ...
                        <>
                            ...
                            <div class="py-5 space-y-5">
                                ...
                                <div class="space-y-3 bg-white dark:bg-white/[0.02] border border-[#c6c5d3] dark:border-white/[0.04] rounded-[4px] p-4 text-[11px] font-sans">
