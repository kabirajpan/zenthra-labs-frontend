            ...
            <div class="w-full max-w-lg bg-white border border-[#c6c5d3] rounded-[6px] shadow-xl p-8 md:p-10 relative overflow-hidden">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-sm text-[#454651] max-w-sm mx-auto">
                        Sign in to Zenthra Developer Accounts to access active build configurations and cloud telemetry dashboards.
                    </p>
                </div>
                ...
                {/* Simulated login form (disabled state) */}
                <div class="space-y-4 mb-6 opacity-40 select-none pointer-events-none">
                    ...
                    <button class="w-full py-2.5 bg-[#c6c5d3] text-white font-medium rounded-[4px] text-sm cursor-not-allowed">Sign In</button>
                </div>
