...
export const head: DocumentHead = {
    title: "Zenthra View — Native Image Viewer | ZenthraLabs",
    meta: [
        ...
        { property: "og:title", content: "Zenthra View — Native Image Viewer | ZenthraLabs" },
        ...
        { name: "twitter:title", content: "Zenthra View — Native Image Viewer | ZenthraLabs" },
