...
const DOWNLOADS: Record<PlatformKey, DownloadOption> = {
    linux: {
        ...
        url: "https://github.com/kabirajpan/Zenthra-Viewer/releases/latest/download/zenthra-view-linux-x86_64.tar.gz",
        icon: (
    ...
    windows: {
        ...
        url: "https://github.com/kabirajpan/Zenthra-Viewer/releases/latest/download/zenthra-view-windows-x86_64.zip",
        icon: (
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                <path d="M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2M7 11l5 5 5-5M12 4v12"/>
            </svg>
    ...
    macos: {
        ...
        url: "https://github.com/kabirajpan/Zenthra-Viewer/releases/latest/download/zenthra-view-macos-universal.tar.gz",
        icon: (
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
                <path d="M4 17v2a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-2M7 11l5 5 5-5M12 4v12"/>
            </svg>
    ...
    unknown: {
        ...
        url: "https://github.com/kabirajpan/Zenthra-Viewer/releases",
        icon: (
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
        ...
        <section class="max-w-4xl mx-auto px-6 py-12 md:py-20">
            ...
            <div class="text-center mb-16 space-y-4">
                <div class="flex justify-center gap-4 text-xs font-medium">
                    <a href="/products/zenthra/apps/zenthra-view" class="inline-flex items-center gap-1.5 text-[#5c6bc0] hover:text-[#4d5cb0] transition-colors">
